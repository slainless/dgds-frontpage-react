...
export default function FeatureSection() {
  return (
    <DoubleSectionWithH2 id="fitur" title="Fitur Digides"
    leftColumn={
      <Text>
    ...
    rightColumn={
      <Box position="relative">
        <Image src="https://digitaldesa.id/templates/homepage/media/misc/solusiDigitalBG.png"
        rounded="xl"/>
        <PlayButton position="absolute" aria-label="Play video"
        top="50%" left="50%"
